...
my_url <- "https://raw.githubusercontent.com/CEU-Economics-and-Business/ECBS-5208-Coding-1-Business-Analytics/master/class_6/data/life_expecatncy/raw/WDI_lifeexp_raw.csv"
df <- read_csv( my_url )
...
write_csv( df, paste0(my_path,'clean/WDI_lifeexp_clean.csv'))
